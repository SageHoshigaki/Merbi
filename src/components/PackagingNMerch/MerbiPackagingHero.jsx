// src/components/PackagingNMerch/MerbiPackagingHero.jsx
...
const heroMedia = {
  src: "/videos/lo.mp4",
  poster: "/images/merch/temp.png",
  position: "center",
  alt: "Merbi packaging, merchandise, and physical brand design",
};
...
export default function MerbiPackagingHero() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/90 via-black/5 to-black/24" />
      </div>
          ...
          >
            <div className="grid max-w-[980px] gap-6 sm:grid-cols-[1fr_auto] sm:items-end">
              <p className="max-w-[790px] text-[17px] leading-[1.58] tracking-[-0.025em] text-white/72 sm:text-[19px] lg:text-[21px]">
                Merbi turns brand thinking into packaging, garments, objects,
                and physical details that make a product feel considered before
                it is ever opened, worn, or used.
              </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a
                href="#packaging-merch-introduction"
      ...
      <motion.a
        ...
        aria-label="Explore Merbi packaging and merchandise design"
